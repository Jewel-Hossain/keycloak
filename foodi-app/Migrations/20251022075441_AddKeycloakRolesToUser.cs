...
{
    /// <inheritdoc />
    public partial class AddKeycloakRolesToUser : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SyncedToKeycloak = table.Column<bool>(type: "INTEGER", nullable: false),
                    KeycloakUserId = table.Column<string>(type: "TEXT", nullable: true),
                    Roles = table.Column<string>(type: "TEXT", nullable: false),
                    KeycloakRoles = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Classic tomato and mozzarella", "/images/pizza.jpg", true, "Margherita Pizza", 12.99m },
                    { 2, "Juicy beef patty with cheese", "/images/burger.jpg", true, "Cheeseburger", 9.99m },
                    { 3, "Fresh romaine with parmesan", "/images/salad.jpg", true, "Caesar Salad", 7.99m },
                    { 4, "Creamy pasta with bacon", "/images/pasta.jpg", true, "Spaghetti Carbonara", 13.99m },
                    { 5, "Crispy wings with hot sauce", "/images/wings.jpg", true, "Chicken Wings", 8.99m },
                    { 6, "Fresh fish with salsa", "/images/tacos.jpg", true, "Fish Tacos", 11.99m }
                });
